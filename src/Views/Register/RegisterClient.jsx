...
const RegisterClient = ({setRegisteringClient, setUser}) => {
    ...
    const handleError = (errorTitle, errorBody) => {
        setErrorMessage({
            title: errorTitle,
            body: errorBody,
        });
            ...
            createClient(values)
                ...
                .catch(error => {
                    if (error.response.data.error === "El RUC ya está registrado") {
                        handleError("RUC duplicado", "El RUC ya está registrado, por favor verifique los datos ingresados o contacte con el administrador del sistema al correo correo@correo.com");
                    } else {
                        handleError("Error", "Ha ocurrido un error, por favor intente nuevamente o contacte con el administrador del sistema al correo correo@correo.com");
                    }
                }
                );
        }
